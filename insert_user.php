...
if(isset($_POST['sign_up']))
  {
      ...
      $username =strtolower($first_name . "_" . $last_name . "_" . $newgid); 
       ...
       $rand = rand(1, 3); // Random number btn 1 and 3
       ...
       if($rand ==1)
         ...
         values('$first_name','$last_name','$username','Hello Traveling Companion . This is my default status!','...','$pass','$email','$country','$gender','$birthday','$profile_pic','default_cover.jpg',NOW(),'$status','$posts','Iwanttoputadingintheuniverse.')" ;
