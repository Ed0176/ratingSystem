    ...
    if(isset($_POST['sub']))
    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    echo "<script>alert('Error occured during uploading!')</script>";
                    echo "<script>window.open('home.php', '_self')</script>";  
                }
                else
                {
 ...
 function get_posts() 
 {
   ...
   function single_post()
   {
       if(isset($_GET['post_id']))
       {
           ...
           $get_com = "select * from the user where user_email='$user_com' ";
           ...
           $get_posts = "select pos_id from users where post_id='$post_id' ";
           ...
           else
           {
            ...
            else if(strlen($content) >=1 && strlen($upload_image >=1))
            {
              ...
              <div class='panel panel-info'>
                ...
                <button class='btn btn-info pull_right' name='reply'>Comment </button>
                </form>
              </div>
              </div>
              </div>
